    ...
    namespace cxx_test
    {
        ...
        public:
            struct Cols
            {
                ...
                static const std::string _personal_data_id;
            ...
            /**  For column personal_data_id  */
            /// Get the value of the column personal_data_id, returns the default value if the column is null
            const int32_t &getValueOfPersonalDataId() const noexcept;
            /// Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
            const std::shared_ptr<int32_t> &getPersonalDataId() const noexcept;
            /// Set the value of the column personal_data_id
            void setPersonalDataId(const int32_t &pPersonalDataId) noexcept;
            void setPersonalDataIdToNull() noexcept;
            ...
            PersonalData getPersonal_data(const drogon::orm::DbClientPtr &clientPtr) const;
            void getPersonal_data(const drogon::orm::DbClientPtr &clientPtr,
        ...
        private:
            ...
            std::shared_ptr<int32_t> personalDataId_;
